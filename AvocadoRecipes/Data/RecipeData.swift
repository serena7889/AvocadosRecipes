...
let recipeData = [
    ...
    Recipe(
      ...
      imageName: "avocado-toast-hollandaise",
      rating: 4,
      serves: 4,
      preparation: 15,
      cooking: 25,
    ...
    Recipe(
      ...
      imageName: "avocado-sandwich-turkey",
      rating: 4,
      serves: 1,
      preparation: 10,
      cooking: 0,
    ...
    Recipe(
      ...
      imageName: "avocado-crunchy-celery-salsa",
      rating: 5,
      serves: 1,
      preparation: 10,
      cooking: 5,
    ...
    Recipe(
      ...
      imageName: "avocado-guacamole-trio",
      rating: 4,
      serves: 1,
      preparation: 10,
      cooking: 0,
    ...
    Recipe(
      ...
      imageName: "avocado-smoothie-bowl",
      rating: 5,
      serves: 1,
      preparation: 15,
      cooking: 10,
